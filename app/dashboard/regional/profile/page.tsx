    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch('/api/user/profile', {
                ...
                // Backend memerlukan form kosong untuk password jika tidak diganti
    ...
    return (
        <div className="pb-10 max-w-4xl mx-auto animate-in fade-in duration-500 relative">
            ...
            <div className="mb-6 md:mb-8">
                ...
                <p className="text-xs md:text-sm text-slate-500 mt-1 font-medium">Kelola informasi dasar akun manajerial wilayah Anda.</p>
            </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <label className="text-[11px] md:text-xs font-bold text-slate-400 uppercase tracking-widest ml-2">Area Otorisasi (Region)</label>
                            <input
                                type="text"
                                value={`Manajer Provinsi (${userState})`}
                                readOnly
                                disabled
                                className="w-full mt-2 bg-slate-50 border border-slate-200 rounded-[20px] px-5 py-3.5 md:py-4 text-sm font-semibold text-slate-400 cursor-not-allowed"
                            />
